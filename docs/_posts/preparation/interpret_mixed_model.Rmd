...
You find it time-consuming to manually format, copy and paste output values to your report or manuscript? This time is over, as the `psycho` package is here for you!
...
The `analyze` function, available in the `psycho` package, transform a fit object into several objects.

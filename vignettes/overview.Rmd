...
analyzed <- psycho::analyze(fit)

# We can extract a formatted summary table
summary(analyzed, round = 2)
```
```{r echo=FALSE, message=FALSE, warning=FALSE}
knitr::kable(summary(analyzed, round = 2))
```
...
# Traditional output
analyzed <- psycho::analyze(fit, effsize = TRUE)
summary(analyzed, round = 2)
```

```{r echo=FALSE, message=FALSE, warning=FALSE}
kable(summary(analyzed, round = 2))
```

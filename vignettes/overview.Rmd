...
Obviously, you need to learn more about Bayesian analyses before running them. You can find more information in the rstanarm's [vignettes](https://cran.r-project.org/web/packages/rstanarm/vignettes/rstanarm.html).
